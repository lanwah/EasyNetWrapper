...
namespace EasyNet.Security
{
    ...
    public partial class Crc16Provider : CrcProvider<UInt16>
    {
        ...
        /// 初始值
        /// </summary>
        public override UInt16 Init => 0x0000;
        /// <summary>
        /// 异或值XOROUT
        /// </summary>
        public override UInt16 Seed => 0x0000;
        /// <summary>
        /// Ansi CRC 16 位校验表 
        /// </summary>
        public virtual UInt16[] CrcTable => CRC_TABLE;

        /// <summary>
        /// 生成多项式
        /// </summary>
        private static readonly string POLYNOMIAL = "x^16 + x^15 + x^2 + 1";
        /// <summary> 
        /// Ansi CRC 16 位校验表 
        /// </summary> 
...
#pragma warning restore IDE0300 // 简化集合初始化
        ...
        /// </summary>
        /// <param name="sourceCrc">源Ansi CRC16校验码</param>
        ...
        {
            var crcCode = (UInt16)(sourceCrc >> 8);
            sourceCrc <<= 8;

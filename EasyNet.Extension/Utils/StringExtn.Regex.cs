...
namespace EasyNet.Extension.Utils
{
    /// <summary>
    /// String 扩展方法
    /// </summary>
    public static partial class StringExtn
    {
        ...
        public static int GetStringCount(this string @this, string value, int startIndex = 0)
        {

...
namespace EasyNet.Demo
{
    ...
    public partial class FormEasyNetWinForm : Form
    {
        ...
        private void Init()
        {
            ...
            {
                IEnumerable<AutocompleteItem> items = Person.PersonList.Select(c =>
                {
                    return c.AutocompleteItemBuilder();
                });
            ...
            // 初始化选中项
            this.historyTextBox1.SelectedItem = Person.PersonList[1].AutocompleteItemBuilder();
    ...
    public static class PersonExts
    {
        public static AutocompleteItem AutocompleteItemBuilder(this Person @this)
        {
            var item = new AutocompleteItem()
            {
                Key = @this.Gender,
